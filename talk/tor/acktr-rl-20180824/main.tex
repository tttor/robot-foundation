...
\title[LSTD LQR RL] {
    Least-Squares Temporal Difference Learning for the Linear Quadratic Regulator ~\cite{Shalev-Shwartz2014} \\
    \vspace{5mm}
    (ML Reading Group, UQ)
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{cvx}
% \include{cvx_learning}
% \include{surrogate}
% \include{gradient_descent}
% \include{subgradient}
% \include{stoc_gradient_descent}
% \include{learning_with_sgd}
\include{conclusion}
\include{biblio}
\include{thank}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
